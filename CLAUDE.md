...
- **Track Record:** $1M → $100M revenue scaling, 1,000+ ISV ecosystems.
- **Target Roles:** Director / Senior Manager BD at AI-native companies.

## Core Metrics (Non-Negotiable)
- **Huawei:** $1M → $100M ecosystem rev, 1,000+ ISVs, 300% SDK growth, 2x President's Award.
- **Qualia:** $9M at 120% goal as FIRST BD hire, $20M pipeline.
...
- **AI Fluency:** AWS GenAI Certified, Google Cloud Digital Leader, AI Partnership Stack.
- **Expertise:** Edge AI, NPU, SoC, API-first BD, MCP/A2A integration protocols.

## Behavioral Instructions
- **Data Integrity:** Never change my core metrics ($20M, 120%, 1,000+, etc.).
- **Consultative Voice:** I am a peer. Do not explain basic concepts. Match JD language exactly.
- **Workflow:** When I use a slash command, follow the **Plan -> Act -> Validate** cycle.
- **Efficiency:** My background is in this file. Do not repeat it in every response unless asked.
- **Validation:** Always check for gap bridges in every application/referral strategy.

## Contact
pranjal.mahna@gmail.com | 424.298.7516 | [linkedin.com/in/pranjalmahna](LinkedIn)

*Refer to BULLET_LIBRARY.md for specific bullet text.*
